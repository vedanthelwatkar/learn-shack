...
export default function StudyAbroadCarousel() {
  ...
  return (
    <div className="bg-brand-secondary py-[60px] sm:py-20 w-full flex flex-col gap-8 sm:gap-12 items-center justify-center max-w-[100vw] overflow-x-hidden">
      <div className="flex flex-col gap-8 sm:gap-12 w-full">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 sm:px-[60px]">
        ...
        <div
          className="relative overflow-hidden w-full touch-pan-y sm:pl-[60px]"
